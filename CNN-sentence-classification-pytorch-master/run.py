...
def train(data, params):
    if params["MODEL"] != "rand":
        ...
        word_vectors = KeyedVectors.load_word2vec_format("vec/wiki.multi.en.vec", binary=False)
        ...
        for i in range(len(data["vocab"])):
            ...
            if word in word_vectors.vocab:
                ...
                fr=fr+1
            elif word in word_vectors1.vocab:
                wv_matrix.append(word_vectors1.word_vec(word))
                ar=ar+1
            else:
...
def main():
    ...
    data["classes"] = (list(set(data["train_y"])))
